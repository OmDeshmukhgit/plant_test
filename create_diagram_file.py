# Create a new Python file for generating the transfer learning diagram
with open('generate_transfer_learning_diagram.py', 'w') as file:
    file.write("""from graphviz import Digraph
...
print("File 'generate_transfer_learning_diagram.py' created successfully.")